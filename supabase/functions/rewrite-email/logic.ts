...
export function buildGeminiEmailRewritePrompt(input: ValidEmailRewriteRequest) {
  return [
    ...
    '- The body must contain only the final email body. No subject, markdown, bullets, labels, or analysis.',
    '- Use 1-2 short paragraphs, ideally 120-180 words.',
    ...
    '- End with a brief thank-you and the provided contact details. If no contact details are provided, end with "Thank you."',
